...
const Card = ({ imageAddress, heading, text }) => {
    return (
        <motion.div initial={{ scale: 0 }} whileInView={{ scale: 1, transition: { duration: .5 } }} className="relative w-[100%] xl:w-[34rem] flex flex-col justify-start items-start gap-[1rem] vsm:p-[2rem] p-[1.2rem] m-2 bg-white rounded-3xl">
