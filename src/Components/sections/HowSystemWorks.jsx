...
const HowSystemWorks = () => {
  return (
    <section className="How-system-works-sectio relative py-8 px-2 w-[95%] 4xl:max-w-[120rem] flex flex-col justify-center items-center gap-[2rem] bg-gradient-to-t from-[#fbc2ebbd] to-[#a6c0eec8] rounded-[2rem]">
      ...
      <motion.div initial={{ scale: 0 }} whileInView={{ scale: 1, transition: { duration: 1 } }} className="slogan max-w-[60rem] text-center lg:text-[3.4rem] md:text-[2rem] sm:text-[2.2rem] vsm:text-[1.8rem] text-[1.6rem] lg:leading-[3.4rem] md:leading-[2rem] sm:leading-[2.8rem] vsm:leading-[2rem] leading-[1.6rem] font-bold ">
